    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-xl p-5 sm:p-6 shadow-xs space-y-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="px-2.5 py-0.5 rounded-md text-xs font-mono font-bold bg-neutral-900 dark:bg-white text-white dark:text-slate-900 tracking-wider">
                {category}
              </span>
            </div>
            ...
            <div className="flex items-baseline gap-3 flex-wrap">
              <h1 className="text-xl font-extrabold text-neutral-900 dark:text-white tracking-tight flex items-center gap-2">
                <Hash className="w-5 h-5 text-neutral-600 dark:text-slate-400" />
              ...
              {data && (
                <div className="flex items-center gap-2 text-xs font-medium">
                  ...
                  {data.minNumber > 0 && data.maxNumber > 0 && (
                    <span className="bg-neutral-100 dark:bg-slate-800 text-neutral-700 dark:text-slate-300 border border-neutral-200 dark:border-[#1e293b] px-2 py-0.5 rounded-md font-mono">
        ...
        {data && data.allNumbers && data.allNumbers.length > 0 && (
          <div className="pt-3 border-t border-neutral-200 dark:border-[#1e293b] space-y-2.5">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-neutral-800 dark:text-slate-200 flex items-center gap-1.5">
                  <Layers className="w-3.5 h-3.5 text-neutral-600 dark:text-slate-400" />
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg font-mono text-[11px] transition-all cursor-pointer whitespace-nowrap ${
                    selectedNumber === null && numberRange === null
                      ? "bg-neutral-900 dark:bg-white text-white dark:text-slate-900 font-bold shadow-2xs"
            ...
            <div className="flex flex-wrap gap-1.5 max-h-44 overflow-y-auto p-2.5 bg-neutral-50 dark:bg-[#0b101a] rounded-xl border border-neutral-200 dark:border-[#1e293b]">
              {data.allNumbers.map((numItem) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && <span className="w-1.5 h-1.5 rounded-full bg-white dark:bg-[#101728] animate-pulse" />}
                  </button>
                );
              })}
            </div>
              ...
              <div className="p-3.5 bg-amber-50/70 border border-amber-200/80 rounded-xl space-y-2.5 mt-3">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <div className="flex items-center gap-1 bg-white/90 dark:bg-[#101728]/90 border border-amber-300 rounded-lg p-1 shadow-2xs">
                ...
                <div className="flex flex-wrap gap-1.5 max-h-28 overflow-y-auto p-2 bg-white/80 dark:bg-[#101728]/80 rounded-lg border border-amber-200/60">
      ...
      <div className="bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-xl p-4 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <form onSubmit={handleSearchSubmit} className="flex flex-col sm:flex-row gap-2 flex-1 max-w-xl">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-8 py-2 text-xs border border-neutral-300 dark:border-[#2b3a54] rounded-lg focus:outline-none focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900 font-mono font-medium transition-colors"
            />
            {searchQuery && (
              <button
                type="button"
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <button
              ...
              disabled={loading}
              className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-neutral-100 dark:bg-slate-800 hover:bg-neutral-200 dark:hover:bg-slate-700 dark:bg-slate-700 text-neutral-700 dark:text-slate-300 text-xs font-semibold border border-neutral-300 dark:border-[#2b3a54] transition-colors cursor-pointer"
              title="Search stored codes in local database"
            >
              <Search className="w-3.5 h-3.5 text-neutral-500 dark:text-slate-400" />
              <span>Search DB</span>
            </button>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-1.5 text-xs text-neutral-600 dark:text-slate-400">
            ...
            <select
              ...
              className="bg-neutral-50 dark:bg-[#0b101a] border border-neutral-300 dark:border-[#2b3a54] text-neutral-800 dark:text-slate-200 text-xs rounded-lg py-1.5 px-2.5 focus:outline-none focus:ring-1 focus:ring-neutral-500 cursor-pointer font-medium"
            >
          ...
          {/* View Mode Switch */}
          <div className="flex items-center bg-neutral-100 dark:bg-slate-800 border border-neutral-200 dark:border-[#1e293b] rounded-lg p-0.5">
            <button
              onClick={() => setViewMode("numbered-grid")}
              className={`p-1.5 rounded-md transition-colors cursor-pointer ${
                viewMode === "numbered-grid"
                  ? "bg-white dark:bg-[#101728] text-neutral-900 dark:text-white shadow-2xs font-bold"
                  : "text-neutral-500 dark:text-slate-400 hover:text-neutral-900 dark:text-white"
              }`}
      ...
      {loading ? (
        <div className="bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-xl p-12 text-center text-neutral-400 dark:text-slate-500 shadow-xs">
          ...
          <p className="text-xs font-medium text-neutral-700 dark:text-slate-300">Loading {category} numbered catalog...</p>
        </div>
      ) : !data || data.items.length === 0 ? (
        <div className="bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-xl p-12 text-center text-neutral-400 dark:text-slate-500 shadow-xs space-y-3">
          <Search className="w-8 h-8 mx-auto text-neutral-400 dark:text-slate-500" />
          <h3 className="text-sm font-bold text-neutral-800 dark:text-slate-200">No releases found in {category}</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {data.items.map((item) => (
            <div
              key={item.code}
              className="group bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] hover:border-neutral-400 dark:hover:border-slate-600 dark:border-slate-600 rounded-xl overflow-hidden shadow-xs hover:shadow-md transition-all flex flex-col"
            >
              ...
              <div className="bg-neutral-900 dark:bg-white text-white dark:text-slate-900 px-3.5 py-2 flex items-center justify-between">
                ...
                {item.duration && (
                  <span className="text-[10px] text-neutral-400 dark:text-slate-500 font-mono flex items-center gap-1">
              ...
              <div className="relative aspect-video bg-neutral-950 overflow-hidden">
                {item.thumbnail ? (
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center text-neutral-600 dark:text-slate-400 bg-neutral-900 dark:bg-white p-4 text-center">
                    <Film className="w-8 h-8 mb-1 opacity-50 text-neutral-500 dark:text-slate-400" />
                    <span className="text-[11px] font-mono text-neutral-400 dark:text-slate-500">{item.code}</span>
                  </div>
                )}
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 p-2">
                  ...
                  {item.postUrl && (
                    <a
                      ...
                      className="p-1.5 bg-white/90 dark:bg-[#101728]/90 hover:bg-white dark:bg-[#101728] text-neutral-900 dark:text-white rounded-lg shadow-md transition-colors"
              ...
              <div className="p-3.5 flex-1 flex flex-col justify-between space-y-3">
                <div>
                  <h3
                    className="text-xs font-bold text-neutral-900 dark:text-white line-clamp-2 leading-snug group-hover:text-neutral-700 dark:text-slate-300 transition-colors"
                    title={item.title}
                  >
                    {item.title}
                  </h3>
                ...
                <div className="pt-2 border-t border-neutral-100 flex items-center justify-between text-[11px] text-neutral-500 dark:text-slate-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {data.items.map((item) => (
            <div
              key={item.code}
              className="bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-xl overflow-hidden shadow-xs hover:border-neutral-400 dark:hover:border-slate-600 dark:border-slate-600 transition-all flex flex-col"
            >
              <div className="relative aspect-video bg-neutral-950">
                {item.thumbnail ? (
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center text-neutral-600 dark:text-slate-400 bg-neutral-900 dark:bg-white p-4">
              ...
              <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                <div className="space-y-2">
                  <h3 className="text-xs font-bold text-neutral-900 dark:text-white line-clamp-2" title={item.title}>
                    {item.title}
                  </h3>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs whitespace-nowrap">
              ...
              <tbody className="divide-y divide-neutral-100">
                {data.items.map((item) => (
                  <tr key={item.code} className="hover:bg-neutral-50 dark:hover:bg-[#1e293b] dark:bg-[#0b101a] transition-colors">
                    <td className="px-4 py-3">
                      <span className="px-2 py-0.5 rounded bg-neutral-900 dark:bg-white text-white dark:text-slate-900 font-mono font-bold text-[11px]">
                        #{item.number > 0 ? item.number : item.numberFormatted}
                      </span>
                    </td>
                    ...
                    <td className="px-4 py-3 max-w-[280px] truncate text-neutral-700 dark:text-slate-300 font-medium">
                      {item.title}
                    </td>
                    <td className="px-4 py-3">
                      {item.actressName ? (
                    ...
                    <td className="px-4 py-3 text-right space-x-2">
                      ...
                      {item.postUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center justify-center p-1 text-neutral-400 dark:text-slate-500 hover:text-blue-600 hover:bg-blue-50 rounded transition-colors"
      ...
      {showMissingModal && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#101728] rounded-2xl border border-neutral-200 dark:border-[#1e293b] shadow-2xl max-w-3xl w-full p-6 space-y-4 max-h-[92vh] flex flex-col">
            {/* Modal Header */}
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    {searchMissingLoading ? (
                      ...
                      <span className="px-2.5 py-0.5 rounded-full bg-neutral-100 dark:bg-slate-800 text-neutral-700 dark:text-slate-300 text-[11px] font-bold font-mono border border-neutral-200 dark:border-[#1e293b]">
                        SEARCH COMPLETED
                      </span>
                    )}
                  </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-4 pr-1">
              ...
              <div className="p-3.5 bg-neutral-900 dark:bg-white text-white dark:text-slate-900 rounded-xl space-y-2.5 shadow-xs">
                <div className="flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2 font-mono">
                    <RefreshCw className={`w-3.5 h-3.5 ${searchMissingLoading ? "animate-spin text-amber-400" : "text-emerald-400"}`} />
                    <span className="font-bold text-neutral-200 dark:text-slate-600">
                      {searchMissingLoading
                ...
                <div className="w-full bg-neutral-800 dark:bg-slate-200 h-2.5 rounded-full overflow-hidden relative">
                  <div
                  ...
                  >
                    {searchMissingLoading && (
                      <div className="absolute inset-0 bg-white/20 dark:bg-[#101728]/20 animate-pulse" />
                    )}
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-2 pt-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 max-h-48 overflow-y-auto p-1">
                    {liveFoundItems.map((item: any) => (
                      <div
                        key={`live-${item.code}`}
                        className="p-2.5 bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-xl flex items-center gap-3 shadow-2xs hover:border-emerald-300 transition-colors"
                      >
                        {item.thumbnail ? (
                          <img
                            src={item.thumbnail}
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-1.5">
                            <span className="px-1.5 py-0.5 rounded bg-neutral-900 dark:bg-white text-white dark:text-slate-900 font-mono text-[10px] font-bold">
                              {item.code}
                            </span>
                            {item.duration && (
                          ...
                          <h5 className="text-xs font-semibold text-neutral-900 dark:text-white truncate mt-0.5">
                            {item.title}
                          </h5>
                          {item.actress && (
              ...
              {!searchMissingLoading && missingSearchReport && (
                <div className="space-y-3 pt-2 border-t border-neutral-200 dark:border-[#1e293b]">
                  {missingSearchReport.success ? (
                    <>
                      <div className="grid grid-cols-3 gap-3 text-center">
                        <div className="p-3 bg-neutral-50 dark:bg-[#0b101a] border border-neutral-200 dark:border-[#1e293b] rounded-xl">
                          <div className="text-[11px] font-medium text-neutral-500 dark:text-slate-400">Searched Targets</div>
                          <div className="text-lg font-extrabold text-neutral-900 dark:text-white font-mono">
            ...
            {/* Modal Footer */}
            {!searchMissingLoading && (
              <div className="pt-3 border-t border-neutral-200 dark:border-[#1e293b] flex items-center justify-between flex-wrap gap-2">
