  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-5 bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-2xl shadow-xs space-y-4">
        <div>
          <h3 className="text-sm font-semibold text-neutral-900 dark:text-white">Universal Bulk Scraper</h3>
        </div>

        <form onSubmit={onScrape} className="space-y-3">
          <div className="flex items-center gap-2">
            <div className="relative flex-1">
              <Globe className="w-4 h-4 text-neutral-400 dark:text-slate-500 absolute left-3.5 top-1/2 -translate-y-1/2" />
              <input
                id="input-bulk-url"
                type="url"
                value={bulkUrl}
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-neutral-50 dark:bg-[#0b101a] border border-neutral-200 dark:border-[#1e293b] rounded-xl text-xs font-mono focus:outline-hidden focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-900 transition-all"
              />
            </div>
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap text-xs text-neutral-600 dark:text-slate-400 pt-1">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-[11px] text-neutral-400 dark:text-slate-500">Presets:</span>
              <button
                type="button"
                onClick={() => setBulkUrl("https://javtiful.com/main")}
                className="text-[11px] text-neutral-600 dark:text-slate-400 hover:text-neutral-900 dark:text-white underline font-mono"
              >
                /main
              </button>
              <button
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            {commitReceipt.commitUrl && (
              <a
                ...
                className="px-3 py-1.5 bg-white dark:bg-[#101728] border border-emerald-300 rounded-lg text-xs font-medium text-emerald-900 hover:bg-emerald-100 flex items-center gap-1.5 transition-colors shrink-0"
              >
      ...
      {bulkScrapeResult && (
        <div className="space-y-4">
          <div className="p-4 bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-xl flex items-center justify-between gap-4 flex-wrap shadow-xs">
            <div className="flex items-center gap-4 flex-wrap text-xs text-neutral-600 dark:text-slate-400">
