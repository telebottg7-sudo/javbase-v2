      ...
      <div className="space-y-6">
        ...
        <div className="p-5 bg-white border border-neutral-200 rounded-2xl shadow-xs space-y-4">
          ...
          <div className="flex items-center gap-3 pt-2 border-t border-neutral-100">
            <div className="w-12 h-12 rounded-xl bg-neutral-100 border border-neutral-200 flex items-center justify-center text-neutral-700 shrink-0 shadow-xs">
        ...
        {studioVideosLoading && studioVideos.length === 0 ? (
          ...
          <div className="p-12 text-center space-y-2 bg-white border border-neutral-200 rounded-2xl">
            ...
            <p className="text-sm font-semibold text-neutral-700">No releases found</p>
            <p className="text-xs text-neutral-500">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
            {studios.map((studio, idx) => (
              <div
                ...
                className="p-4 bg-white border border-neutral-200 rounded-xl hover:border-neutral-400 hover:shadow-xs transition-all flex flex-col items-center text-center space-y-2 group cursor-pointer"
              >
                <div className="w-12 h-12 rounded-xl bg-neutral-100 flex items-center justify-center text-neutral-600 group-hover:scale-105 transition-transform duration-200 border border-neutral-200">
                  <Building className="w-6 h-6" />
                </div>
