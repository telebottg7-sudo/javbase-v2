      ...
      <div className="space-y-6">
        ...
        <div className="p-5 bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-2xl shadow-xs space-y-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-2 border-t border-neutral-100">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-neutral-100 dark:bg-slate-800 border border-neutral-200 dark:border-[#1e293b] overflow-hidden shrink-0 shadow-xs">
                {selectedActressThumbnail ? (
                  <img
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-3 text-xs text-neutral-500 dark:text-slate-400 flex-wrap">
                  <span className="font-mono text-neutral-400 dark:text-slate-500">
                    /actress/{selectedActress}
                  </span>
                  {selectedActressVideoCount !== undefined && (
                    <span className="px-2 py-0.5 bg-neutral-100 dark:bg-slate-800 border border-neutral-200 dark:border-[#1e293b] rounded-md font-medium text-neutral-700 dark:text-slate-300 flex items-center gap-1">
                      <Film className="w-3 h-3 text-neutral-400 dark:text-slate-500" />
          ...
          <div className="pt-4 border-t border-neutral-100 bg-neutral-50/60 dark:bg-[#0b101a]/60 -mx-5 -mb-5 p-5 rounded-b-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <label
                htmlFor="actress-filter-duplicates"
                className="flex items-center gap-2.5 cursor-pointer text-xs font-medium text-neutral-700 dark:text-slate-300 select-none"
              >
                <input
                  ...
                  className="w-4 h-4 rounded border-neutral-300 dark:border-[#2b3a54] text-neutral-900 dark:text-white focus:ring-neutral-900 accent-neutral-900"
                />
        ...
        {actressVideosLoading && actressVideos.length === 0 ? (
          ...
          <div className="p-12 text-center space-y-2 bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-2xl">
            ...
            <p className="text-sm font-semibold text-neutral-700 dark:text-slate-300">No movies found</p>
            <p className="text-xs text-neutral-500 dark:text-slate-400">
              {filterDuplicates
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
            {actresses.map((actress, idx) => (
              <div
                ...
                className="p-3 bg-white dark:bg-[#101728] border border-neutral-200 dark:border-[#1e293b] rounded-xl hover:border-neutral-400 dark:hover:border-slate-600 dark:border-slate-600 hover:shadow-xs transition-all flex flex-col items-center text-center space-y-2 group cursor-pointer"
              >
                <div className="w-16 h-16 rounded-full bg-neutral-100 dark:bg-slate-800 overflow-hidden border border-neutral-200 dark:border-[#1e293b] group-hover:scale-105 transition-transform duration-200">
                  {actress.thumbnail ? (
                    <img
