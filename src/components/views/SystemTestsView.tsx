    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      <div>
        <h1 className="text-2xl font-bold text-neutral-900 dark:text-white tracking-tight flex items-center gap-2">
          <Bug className="w-6 h-6 text-neutral-500 dark:text-slate-400" />
          System Test Suites
        </h1>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-[#101728] rounded-xl border border-neutral-200 dark:border-[#1e293b] p-5 shadow-xs">
          ...
          {ingestionTestReport && (
            <div className="mt-4 pt-4 border-t border-neutral-100 space-y-3">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs text-neutral-500 dark:text-slate-400 font-mono bg-neutral-100 dark:bg-slate-800 px-2 py-1 rounded-md">
